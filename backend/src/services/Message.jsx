...
export default function Message({ message }) {
  ...
  return (
    <div className={`flex items-end gap-2 my-2 ${isBot ? 'justify-start' : 'justify-end'}`}>
      ...
      <div className={`max-w-xs md:max-w-md lg:max-w-lg px-4 py-2 rounded-2xl ${isBot ? 'bg-gray-100 text-gray-800 rounded-bl-none' : 'bg-blue-500 text-white rounded-br-none'} whitespace-pre-wrap`}>
